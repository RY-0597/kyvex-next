        ...
        <section className="about" id="about">
            <div className="container">
                <div className="about-centered">
                    ...
                    <p className="about-text-main">{t('about.text1')}</p>
                    <p className="about-text-main">{t('about.text2')}</p>
                    <p className="about-text-main">{t('about.text3')}</p>
                    <p className="about-text-main">{t('about.text4')}</p>
                </div>
